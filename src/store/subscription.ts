import store, { setActiveTarrif, setSelectedTarrif, setSubscriptionSaving, setSubscriptionError } from './index'
...
export const useSubscriptionError = () => useStore(store, (s) => s.subscription.error)

export { setActiveTarrif, setSelectedTarrif, setSubscriptionSaving, setSubscriptionError }
