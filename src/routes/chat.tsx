...
import { Avatar, AvatarImage, Box, Circle, Flex, Float, Grid, IconButton, Text } from '@chakra-ui/react'
  ...
  return <>
    <Grid
      ...
      <Flex
        ...
        gapX={4}>
        <Flex gapX={2}>
          <IconButton variant="ghost" onClick={() => navigate({ to: '/' })} children={<IoChevronBack/>} />
