        ...
        () => [
            {
                ...
                accent: 'subscription',
                features: [
                    '10% отчислений в фонды выбранные вами',
                    'Полный PRO-функционал: подробные сценарии, песни по артистам, параметры (голос/BPM/настроение/жанр)',
                    '1 трек = 1 генерация',
                ],
            ...
            {
                id: 'ultra-monthly',
                title: '1 Премиум + безлимит PRO',
                emoji: '💎',
                priceLabel: '4 990 ₽/мес',
                accent: 'tariffs',
                features: [
                    '15% отчислений в фонды выбранные вами',
                    'Премиум-трек с менеджером (до 5 итераций) — доведём до результата + обложка и её оживление',
                    'Безлимитные PRO-генерации',
                ],
                bonus: 'Бонус 48 ч: вторая версия у всех генераций',
                info: '',
            },
        ],
        [],
