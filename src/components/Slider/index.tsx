...
В итоге трек звучит так, будто любимый артист записал его по твоим мыслям 🐾`,
    ...
    },
    {
        ...
        description: "Глубоко проработанные сценарии извлекают из ответов не только факты, но и настроение, внутренние шутки и ситуации. В результате песня кажется невероятно личной и созданной специально для тебя!",
        image: "/slider-2.JPEG",
        onSubmit: () => {
            console.log("submit")
        }
